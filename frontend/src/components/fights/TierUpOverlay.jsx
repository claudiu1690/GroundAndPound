    ...
    <div className="tier-up-overlay" role="dialog" aria-modal="true" aria-label="Fame tier increased">
      <div className="tier-up-modal">
        ...
        <div className="tier-up-hero">
          ...
          <p className="tier-up-eyebrow">The MMA World Is Paying Attention</p>
          <h2 className="tier-up-modal-title">New Fame Tier</h2>
          ...
          <p className="tier-up-desc">Higher tiers increase fight purses and unlock media opportunities and sponsorships.</p>
        </div>
        <div className="tier-up-perks">
          <div className="tier-up-perk-row"><Coins size={16} className="tier-up-perk-icon" /><span className="tier-up-perk-text">Fight purses increase at {tierLabel(toTier)} tier</span></div>
          <div className="tier-up-perk-row"><Mic size={16} className="tier-up-perk-icon" /><span className="tier-up-perk-text">Media opportunities begin to open up</span></div>
          <div className="tier-up-perk-row"><Store size={16} className="tier-up-perk-icon" /><span className="tier-up-perk-text">Sponsorships coming soon</span></div>
        </div>
        <div className="tier-up-footer">
          <button type="button" className="tier-up-dismiss" onClick={onClose}>Continue</button>
        </div>
      </div>
    </div>
  , document.body);
