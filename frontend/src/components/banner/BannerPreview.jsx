...
export const BannerPreview = memo(function BannerPreview({
    ...
    const layoutKey = (layout?.id || "LAYOUT_STACKED").replace("LAYOUT_", "").toLowerCase();
    // Long names get a lower type ceiling so they fit before ellipsis kicks in.
    const longName = (layoutKey === "stacked" || layoutKey === "broadcast" ? d.last : `${d.first} ${d.last}`).length > 11;
