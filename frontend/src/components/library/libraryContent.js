...
export const LIBRARY_ARTICLES = [
    ...
    },
    {
        ...
        body: [
            "Beating the tier champion is the only way to advance — at every tier except GCS Contender, which promotes automatically at OVR 62. Your very first belt is the Amateur title: beat the Amateur champion (the top contender in your division) to turn pro and move up to Regional Pro. The title shot doesn't appear until three conditions are met: your OVR reaches the next tier's threshold, you've earned enough wins at your current tier, and you're ranked in the top 5 of the division.",
            "The Amateur title shot is your pro debut, so the gates are a touch lighter: reach OVR 30, sit in your division's top 5, and bank 2 wins at the Amateur tier. From Regional Pro upward the win requirement rises to 3. Win the Amateur belt and you earn the distinct Amateur Champion badge plus a fame boost.",
