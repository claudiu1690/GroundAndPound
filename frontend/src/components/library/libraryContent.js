...
export const LIBRARY_ARTICLES = [
    ...
    // ──────────────────────────────────────────────────────────────
    {
        ...
        title: "Events — Fight Card Predictions",
        summary: "How the weekly fight card works, how to predict, and how the rewards break down.",
        tags: ["events", "predictions", "card", "headliner", "weekly"],
        body: [
            "Every week the Events tab runs a 5-fight NPC card featuring GCS-level fighters competing for fame and spectacle. You can't fight on these cards — but you can predict them for iron and notoriety.",
            ...
            "For each fight, you pick a side (Fighter A, Draw, or Fighter B) and optionally a method (KO/TKO, Submission, or Decision). You can predict any subset of the five fights. Each prediction is independent — getting three right and two wrong pays the three correct rewards and the two wrong penalties.",
            "Getting the winner and method exactly right on the Headliner pays +300 fame and +500 iron. Getting just the winner pays +100 fame. Picking the wrong winner costs −50 fame. The card runs for 7 days and resolves automatically. The first time you open the Events tab after resolution, a reveal modal walks you through every result with your verdict and payout per fight.",
        ],
        keyTakeaway: "Exact predictions (winner + method) pay the most. Wrong winner predictions cost fame. Be selective — don't guess on fights you haven't studied.",
    },
    {
        id: "media-hub",
        category: "Events & Media",
