...
export const CATEGORY_COLOR = {
    ...
    // The value is a COLOUR TOKEN, not a category name — it resolves to the `--cat-gym` CSS
    // variable (green). It stays "gym" after the category was renamed to "Training & Camp"
    // because renaming it would point at a `--cat-camp` variable that does not exist.
    "Training & Camp": "gym",
    "Career": "career",
    "Economy": "economy",
    "Health": "health",
...
export const LIBRARY_ARTICLES = [
    ...
    },
    {
        ...
        tags: ["home", "dashboard", "athlete page", "next fight", "bookings", "offer board", "title shot"],
        body: [
        ...
        keyTakeaway: "Top right is your next fight and you can accept it from Home. Everything else on the page is context for that decision.",
    },
    {
    ...
    // ──────────────────────────────────────────────────────────────
    {
        ...
        tags: ["offers", "matchmaking", "offer board", "reroll", "easy", "hard", "title shot", "intel", "threat tags", "callout", "nemesis"],
        body: [
    ...
    },
    {
        ...
        keyTakeaway: "Equip up to 3 moves, unlocked by tier — but no more than 2 always-on Passives at once, so your 3rd slot should be a Proc or Signature. Hard camp sessions roll for drops; promoting a coach is the only way to pick which move you get.",
    },
    ...
    // ──────────────────────────────────────────────────────────────
    {
        ...
        keyTakeaway: "Stats grow through XP. Higher stats cost more XP per point. Training your style's primary stats is the fastest route to a higher Overall.",
    },
    {
        id: "rank-4-perks",
        category: "Training & Camp",
        ...
        body: [
            ...
            {
                type: "table",
                headers: ["Coach", "Perk", "Badge", "What It Actually Means"],
                rows: [
    ...
    },
    {
        ...
        keyTakeaway: "Discipline-mastery badges require the most work but come with permanent perks. Career, Camp and Proving Ground badges tell the story of your biggest moments in the cage, in your gym and on the ladder.",
    },
    {
