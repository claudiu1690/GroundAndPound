...
export const CHANGELOG_ENTRIES = [
  ...
  },
  {
    ...
    sections: {
      ...
      fixed: [
        "Coach morale messages say what morale actually does. \"Thriving — happy in the room\" told you nothing, and a coach at 39 was labelled \"ready to walk, one bad week from quitting\" when he was really 5–13 weeks away. The bands now sit on the thresholds that matter and name the consequence: below 30 his training bonus is halved, at 0 he walks and takes his rank.",
      ...
      balance: [
        "Iron Conditioning, the Conditioning coach's Rank 4 perk, does something useful now: your health regenerates about 30% faster, permanently — a full heal drops from roughly eight hours to under six. It used to double Max Stamina gain per session, which was worthless: stamina caps after 20 sessions and the perk takes 60 to earn, so it always arrived after the job was already done.",
        "Coach morale now recovers. A clean week — wages paid and at least one session run with him — gives a coach +2 back. Previously morale only ever fell: doing everything right merely stopped the bleeding, so one missed payroll scarred a coach at that level permanently unless you hired a Locker-Room Leader. Recovery is slower than the damage on purpose, so a bad month still costs you, it just isn't forever.",
        "Firing a coach no longer locks the slot for 7 days — you can hire a replacement straight away. Firing still costs you his rank, morale across the room and 15 Facility Condition, and the week's market slate can't be rerolled, so churning still gains you nothing. The lockout was mostly punishing people who changed their mind, not people gaming it.",
