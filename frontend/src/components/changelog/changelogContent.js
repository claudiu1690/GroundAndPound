...
export const CHANGELOG_ENTRIES = [
  {
    ...
    highlights: [
      ...
      "The Shop's Premium tab sells Energy Drink bundles now, from 6 at $4.99 up to 100 at $39.99. What money buys is time, not power: a drink is 50 energy, you can still earn every one of them by playing, and nothing on sale changes how a fight turns out. Stripe handles payment on their own page, so your card details never touch this game.",
    ],
    sections: {
      changed: [
        ...
        "Buying drinks needs a registered account with an email and password, so guest accounts can't. That isn't an upsell. A guest account lives on the device that made it, and losing the device would take anything you bought with it.",
      ],
      fixed: [
        "You can finally see the perks you own. Your profile has a Perks Held card, where before there was nowhere in the game that listed them.",
        "Badge notifications use the badge's real name, instead of announcing a rank-4 award as \"Boxer Rank4\" in one place and \"Champion Boxer\" in another.",
        "The Premium tab used to look like a working store and wasn't one. It's real now, and coming back from the payment page lands you on the Shop with a message instead of dropping you on the home screen.",
      ],
      balance: [
        ...
        "Flagship rounds cost 9 energy for slightly less XP per point of energy than your cheap drills, and they wear the building down. That's deliberate: the hard session should be a choice you make for the breadth and the drop chance, not the only button worth pressing.",
        "A Common coach's Rank 4 teaches no move, paying out his discipline's permanent perk instead, because his one move already arrived at Rank 2. If the cheapest coach taught you as much as the most expensive, rarity would be cosmetic.",
        "A Legendary is cheap to sign ($5,000 once) and expensive to keep ($2,250 a week), so hiring the best is an ongoing commitment rather than a one-time savings goal.",
        "Coach morale recovers on a clean week, but slower than it drops, so a bad month costs you without being permanent. An actively-run camp takes no decay at all.",
      ],
    },
  },
  {
